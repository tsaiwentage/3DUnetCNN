...
def original_unet_model(input_shape, pool_size=(2, 2, 2), n_labels=1, initial_learning_rate=0.00001, deconvolution=False,
                  depth=4, n_base_filters=32, metrics=dice_coefficient,
    ...
    for level_number in range(depth - 2, -1, -1):  # [2,1,0]
        ...
        concat = concatenate([up_convolution, levels[level_number][1]], axis=1)
